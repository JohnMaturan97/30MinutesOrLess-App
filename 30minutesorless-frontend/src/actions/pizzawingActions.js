...
export const getPizzaWingById=(pizzawingid)=>async dispatch=>{
    ...
    try {
        const response = await axios.post('/api/pizzaswings/getpizzawingbyid' , {pizzawingid})
        console.log(response);
...
export const addPizzaWing=(pizzawing)=>async dispatch=>{
    ...
    try {
        const response= await axios.post('/api/pizzaswings/addpizzawing' , {pizzawing})
        console.log(response);
...
export const editPizzaWing=(editedpizzawing)=>async dispatch=>{
    ...
    try {
        const response= await axios.post('/api/pizzaswings/editpizzawing' , {editedpizzawing})
        console.log(response);
...
export const deletePizzaWing=(pizzawingid)=>async dispatch=>{
    ...
    try {
        const response =await axios.post('/api/pizzaswings/deletepizzawing' , {pizzawingid})
